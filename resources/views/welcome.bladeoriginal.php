...
<body
    ...
    style="
        background-image: url('{{ asset('images/bg1.webp') }}');
        ...
        @if (Route::has('login'))
            ...
            <nav class="flex items-center justify-end gap-4">
                    ...
                    @if (auth()->user()->role === 'admin')
                        <a href="{{ route('dashboard') }}"
                            class="inline-block px-5 py-1.5 dark:text-[#EDEDEC]
                                       border-[#19140035] hover:border-[#1915014a] border
                                       text-[#1b1b18] dark:border-[#3E3E3A]
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-5 py-1.5 dark:text-[#EDEDEC]
                                   text-[#1b1b18] border border-transparent
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                class="relative lg:-ms-px -mb-px lg:mb-0
           rounded-t-lg lg:rounded-t-none lg:rounded-e-lg
           aspect-[335/376] lg:aspect-auto
