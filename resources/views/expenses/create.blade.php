                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="amount" required step="0.01"
                            class="w-full rounded-lg border-gray-300 font-bold text-lg">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="w-full rounded-lg border-gray-300"
                            placeholder="Describe what the money was for..."></textarea>
                    </div>

                    <button type="submit"
                        class="w-full bg-black text-white py-4 rounded-xl font-bold text-lg hover:bg-gray-800 transition shadow-lg">
                        Save Expense Claim
                    </button>
                    <a href="{{ route('expenses.index') }}"
                        class="block text-center text-gray-500 font-medium">Cancel</a>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <!-- <input type="date" name="expense_date" value="{{ date('Y-m-d') }}" class="block w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm
                                          focus:ring-2 focus:ring-black focus:border-black transition"> -->
                        <input type="date" name="expense_date" value="{{ date('Y-m-d') }}" max="{{ date('Y-m-d') }}"
                            class="block w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm focus:ring-2 focus:ring-black focus:border-black transition">
                    </div>
                </div>
